			...
			<div className="bg-white border-b border-slate-100">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
					...
					<div className="mt-8 max-w-2xl mx-auto">
						<div className="flex gap-2 p-1 bg-white shadow-lg shadow-slate-200/50 rounded-2xl border border-slate-100">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
							{tab === "combos" &&
								(items as ComboLibraryItem[]).map((item) => (
									...
									>
										<Card className="h-full overflow-hidden border-slate-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
											{/* Image Cover */}
