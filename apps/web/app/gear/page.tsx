...
export default async function GearPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-8">
      <div className="bg-gradient-to-br from-sky-500 to-blue-600 text-white px-6 pt-10 pb-16 rounded-b-[2.5rem] md:rounded-3xl shadow-lg relative overflow-hidden">
