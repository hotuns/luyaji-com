  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">至少选择一个</p>
        ...
        {loading ? (
          ...
          <div className="bg-gray-50 rounded-xl p-6 text-center">
            <p className="text-gray-500 mb-4">你还没有装备组合，先新建一个吧</p>
            <button
          ...
          <div className="space-y-2">
            ...
            <button
              onClick={() => setShowNewComboForm(true)}
              className="w-full p-4 rounded-xl border-2 border-dashed border-gray-300 text-gray-500 hover:border-blue-400 hover:text-blue-600 transition-colors"
            >
              ＋ 临时新建组合
            </button>
          </div>
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">可选，后续也可以补充</p>
